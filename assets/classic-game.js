import { restoreMain, saveProgress } from './interface-switch.js';
...
const game = restoreMain(createScenario());
...
function render(){
 saveProgress('main',game.getState());
